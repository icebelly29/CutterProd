import { packMicrosegment } from './utils.js';
import { Vector2, CubicBezier } from './math.js';
...
export default class SvgConverter {
    ...
    constructor(options = {}) {
        ...
        this.zFeedRate = options.zFeedRate !== undefined ? options.zFeedRate : 10;
        ...
        this.stepsPerDeg_A = options.stepsPerDeg_A || 51.6;
